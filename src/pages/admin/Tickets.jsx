            ...
            <div className="p-6">
                ...
                <div className="mb-4">
                    <div className="relative max-w-sm">
                        ...
                        <input type="text" placeholder="Cari kode tiket, nama pemesan..." value={search}
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm">
                                ...
                                <tbody className="divide-y divide-gray-50">
                                    ...
                                    t.nama_ketua?.toLowerCase().includes(search.toLowerCase()) ||
                                    t.user?.name?.toLowerCase().includes(search.toLowerCase()) ||
                                    t.destination?.nama_wisata?.toLowerCase().includes(search.toLowerCase())
                                ).map(ticket => (
